...
suite('Paste Converter', () => {
    ...
    suite('Basic conversion', () => {
        ...
        test('should convert unordered list', () => {
            ...
            assert.ok(result!.includes('item 1'), 'should contain item 1');
            assert.ok(result!.includes('item 2'), 'should contain item 2');
            assert.ok(result!.includes('-') || result!.includes('*'), 'should use list markers');
        });
        ...
        test('should convert ordered list', () => {
            ...
            assert.ok(result!.match(/\d+\./), 'should use numbered markers');
        });
